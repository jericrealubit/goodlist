...
- **Alarms ring until answered** — task alarms and medicine reminders use a loud alarm sound
  ...
  follow-up notifications re-ring every minute, easing off, for two hours (`src/lib/alarms/`). Saying *"remind me to X at 5pm"* turns the alarm on automatically; a plain *"add X"* never
