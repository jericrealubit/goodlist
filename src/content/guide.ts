      ...
      blocks: [
        ...
        },
        {
          ...
          spans: [
            ...
            ', ',
            { bold: 'Every month' },
            ' on the same date or the same weekday (like the second Sunday), ',
            { bold: 'Choose days of the week' },
            ' and tap the days you want, or ',
            { bold: 'Choose a day each month' },
            ' — a date such as the 15th, or a weekday such as the last Friday. The next few show up on the calendar; on your list you see today’s, or just the next one.',
          ],
        },
        {
          kind: 'callout',
